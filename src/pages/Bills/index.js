...
const BillsPage = () => {
  ...
  const handleNavigate50 = () => navigate("/");
  const handleNavigate39 = () => navigate("/foodorder");
  const handleNavigate40 = () => navigate("/favoritemenu");
  const handleNavigate41 = () => navigate("/chat");
  const handleNavigate42 = () => navigate("/orderhistory");
  const handleNavigate43 = () => navigate("/settingscustomer");
        ...
        <Row className="items-center justify-start w-[100%]">
          ...
          <Column className="lg:mb-[23px] xl:mb-[26px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[78%]">
            <Row className="items-start justify-between w-[100%]">
              <Text className="font-bold lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left">{`Bills`}</Text>
              <Image
                src="img_menu_6.svg"
            ...
            <Column className="bg-white_A700 items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] rounded-radius16 w-[100%]">
              <Column className="items-center justify-start w-[100%]">
                <Stack className="h-[101px] lg:h-[59px] xl:h-[68px] 2xl:h-[76px] 3xl:h-[91px] w-[100%]">
                  ...
                  <Row className="absolute h-[max-content] inset-y-[0] items-center justify-start my-[auto] right-[10%] w-[73%]">
                    <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Status`}</Text>
                    <Text className="font-semibold lg:ml-[102px] xl:ml-[117px] 2xl:ml-[132px] 3xl:ml-[158px] ml-[176px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Date`}</Text>
                    <Text className="font-semibold xl:ml-[110px] 2xl:ml-[124px] 3xl:ml-[149px] ml-[166px] lg:ml-[96px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Address`}</Text>
                    <Text className="font-semibold lg:ml-[157px] xl:ml-[180px] 2xl:ml-[202px] 3xl:ml-[243px] ml-[270px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Total`}</Text>
                    <Text className="font-semibold lg:ml-[51px] xl:ml-[59px] 2xl:ml-[66px] 3xl:ml-[80px] ml-[89px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Payment Method`}</Text>
                  </Row>
                </Stack>
              ...
              >
                <Row className="bg-white_A700 items-center justify-start my-[0] rounded-radius1 w-[100%]">
                  ...
                  <Row className="items-start justify-start lg:mb-[13px] xl:mb-[15px] 2xl:mb-[17px] 3xl:mb-[20px] mb-[23px] lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] lg:mt-[16px] xl:mt-[19px] 2xl:mt-[21px] 3xl:mt-[26px] mt-[29px] w-[43%]">
                    <Text className="font-medium 2xl:my-[10px] 3xl:my-[12px] my-[13.5px] lg:my-[7px] xl:my-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Order #1`}</Text>
                  ...
                  <Row className="items-center justify-center lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[32px] mb-[36.5px] lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] lg:mt-[24px] xl:mt-[28px] 2xl:mt-[31px] 3xl:mt-[38px] mt-[42.5px] w-[33%]">
                    <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Elm Street, 23 Yogyakarta`}</Text>
                    <Text className="font-semibold lg:ml-[46px] xl:ml-[53px] 2xl:ml-[60px] 3xl:ml-[72px] ml-[80px] text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
                      <span className="text-amber_600 font-poppins">
                    ...
                    <Text className="font-medium lg:ml-[46px] xl:ml-[53px] 2xl:ml-[60px] 3xl:ml-[72px] ml-[80px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Cash`}</Text>
                  </Row>
                ...
                <Row className="bg-amber_600 items-center justify-start my-[0] w-[100%]">
                  ...
                  <Row className="items-center justify-center lg:mb-[23px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] lg:mt-[22px] 2xl:mt-[29px] 3xl:mt-[35px] mt-[39px] xl:my-[26px] w-[33%]">
                    <Text className="font-semibold lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-white_A700">{`Elm Street, 23 Yogyakarta`}</Text>
                    <Text className="font-semibold lg:ml-[46px] xl:ml-[53px] 2xl:ml-[60px] 3xl:ml-[72px] ml-[80px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-white_A700">
                    ...
                    <Text className="font-medium lg:ml-[46px] xl:ml-[53px] 2xl:ml-[60px] 3xl:ml-[72px] ml-[80px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-white_A700">{`Cash`}</Text>
                  </Row>
                  <Button className="bg-transparent lg:h-[28px] xl:h-[33px] 2xl:h-[37px] 3xl:h-[44px] h-[48px] lg:ml-[103px] xl:ml-[118px] 2xl:ml-[133px] 3xl:ml-[160px] ml-[178px] lg:my-[16px] xl:my-[19px] 2xl:my-[21px] 3xl:my-[26px] my-[29px] rounded-radius16 lg:w-[28px] xl:w-[32px] 2xl:w-[36px] 3xl:w-[43px] w-[48px]">
                    {""}
                  </Button>
              ...
              <Row className="bg-white_A700 items-start justify-start shadow-bs3 w-[100%]">
                  ...
                  <Column className="xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
                    ...
                    >
                      <Row className="items-center justify-between lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] w-[100%]">
                        ...
                        <Text className="font-semibold 2xl:mb-[10px] 3xl:mb-[12px] mb-[14px] lg:mb-[8px] xl:mb-[9px] 3xl:mt-[11px] mt-[13px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] text-bluegray_900 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left">
                          <span className="text-bluegray_900 font-poppins">
                            <>{`+`}</>
                          </span>
                          <span className="text-amber_600 font-poppins">
                      ...
                      <Row className="items-center justify-start lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] w-[100%]">
                        ...
                        <Text className="font-semibold 2xl:mb-[10px] 3xl:mb-[12px] mb-[14px] lg:mb-[8px] xl:mb-[9px] lg:ml-[26px] xl:ml-[30px] 2xl:ml-[33px] 3xl:ml-[40px] ml-[45px] 3xl:mt-[11px] mt-[13px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] text-bluegray_900 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left">
                          <span className="text-bluegray_900 font-poppins">
                            <>{`+`}</>
                          </span>
                          <span className="text-amber_600 font-poppins">
                ...
                <Column className="items-start justify-start lg:mb-[28px] xl:mb-[32px] 2xl:mb-[36px] 3xl:mb-[44px] mb-[49px] lg:ml-[18px] xl:ml-[20px] 2xl:ml-[23px] 3xl:ml-[27px] ml-[31px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[18%]">
                  <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Fast Food Resto`}</Text>
                ...
                >
                  <Row className="items-center justify-between 2xl:my-[10px] 3xl:my-[13px] my-[14.5px] lg:my-[8px] xl:my-[9px] w-[100%]">
                    <Column className="items-start w-[40%]">
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Status`}</Text>
                      <Text className="font-medium lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Completed`}</Text>
                    </Column>
                    <Column className="items-start w-[42%]">
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Date`}</Text>
                      <Text className="font-medium lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`June 1, 2020`}</Text>
                    </Column>
                  </Row>
                  <Row className="items-center justify-between 2xl:my-[10px] 3xl:my-[13px] my-[14.5px] lg:my-[8px] xl:my-[9px] w-[100%]">
                    <Column className="items-start w-[30%]">
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Bills`}</Text>
                      <Text className="font-medium lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Order #1`}</Text>
                    </Column>
                    <Column className="items-start w-[42%]">
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Date Paid`}</Text>
                      <Text className="font-medium lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`June 1, 2020`}</Text>
                    </Column>
                  </Row>
                </List>
                ...
                <Column className="items-start justify-start mb-[108px] lg:mb-[63px] xl:mb-[72px] 2xl:mb-[81px] 3xl:mb-[97px] lg:ml-[18px] xl:ml-[20px] 2xl:ml-[23px] 3xl:ml-[27px] ml-[31px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[6%]">
                  <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left">{`Total`}</Text>
                  <Text className="font-bold xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-red_400">
                    <span className="text-amber_600 font-poppins">
                      <>{`$`}</>
                    </span>
                    <span className="text-bluegray_900 font-poppins">
