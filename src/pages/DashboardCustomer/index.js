        ...
        <Row className="items-center justify-between w-[100%]">
              ...
              <Column className="items-center justify-start lg:mb-[348px] xl:mb-[398px] 2xl:mb-[448px] 3xl:mb-[538px] mb-[598px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] mx-[auto] w-[73%]">
                ...
                >
                  <Image
                    ...
                    alt="OrderDiscussio"
                  />
                  <Text className="font-medium lg:ml-[14px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] ml-[24px] lg:my-[13px] xl:my-[15px] 2xl:my-[16px] 3xl:my-[20px] my-[22.5px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Message`}</Text>
                </Row>
                <Row
                  className="common-pointer items-center justify-start xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] rounded-radius20 w-[100%]"
          ...
          <Column className="items-center lg:mb-[23px] xl:mb-[26px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[54%]">
            <Row className="items-start justify-between w-[100%]">
              <Text className="font-bold lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] ml-[1px] text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left w-[auto]">{`Hello, Samantha`}</Text>
            ...
            <Row className="items-center justify-start lg:mt-[23px] xl:mt-[27px] 2xl:mt-[30px] 3xl:mt-[36px] mt-[41px] w-[100%]">
              ...
              <Text className="font-normal xl:mb-[3px] 3xl:mb-[4px] mb-[5px] lg:ml-[479px] xl:ml-[548px] 2xl:ml-[616px] 3xl:ml-[740px] ml-[822px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] not-italic text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`View all`}</Text>
              <Image
            ...
            <Row className="items-center justify-start lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] mt-[40px] w-[100%]">
              <Text className="font-bold text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`Popular Dishes`}</Text>
              <Text className="font-normal xl:mb-[3px] 3xl:mb-[4px] mb-[5px] lg:ml-[440px] xl:ml-[503px] 2xl:ml-[566px] 3xl:ml-[679px] ml-[755px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] not-italic text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`View all`}</Text>
              <Image
                  ...
                  <Column className="lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] w-[100%]">
                    <Row className="items-center justify-between w-[100%]">
                      <Column className="items-start w-[37%]">
                        ...
                        <Text className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-red_400 w-[auto]">
                          <span className="text-amber_600 font-poppins">
                            <>{`$`}</>
                          </span>
                          <span className="text-bluegray_900 font-poppins">
            ...
            <Row className="items-center justify-start lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] mt-[40px] w-[100%]">
              <Text className="font-bold text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`Recent Order`}</Text>
              <Text className="font-normal xl:mb-[3px] 3xl:mb-[4px] mb-[5px] lg:ml-[453px] xl:ml-[518px] 2xl:ml-[583px] 3xl:ml-[699px] ml-[777px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] not-italic text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`View all`}</Text>
              <Image
            ...
            >
              <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                ...
                <Column className="absolute h-[max-content] inset-y-[0] items-start justify-start my-[auto] right-[10%] w-[67%]">
                  ...
                  <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] lg:mx-[23px] xl:mx-[26px] 2xl:mx-[30px] 3xl:mx-[36px] mx-[40px] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[auto]">{`Fish Burger`}</Text>
                  <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] lg:mx-[32px] xl:mx-[37px] 2xl:mx-[42px] 3xl:mx-[50px] mx-[56px] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400 w-[auto]">
                    <span className="text-amber_600 font-poppins">
                      <>{`$`}</>
                    </span>
                    <span className="text-bluegray_900 font-poppins">
                  ...
                  <Row className="items-center justify-start lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] xl:mx-[11px] 2xl:mx-[12px] 3xl:mx-[15px] mx-[17px] lg:mx-[9px] w-[65%]">
                    <Text className="font-normal not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`4.97 km`}</Text>
                    ...
                    <Text className="font-normal lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`21 min`}</Text>
                  </Row>
                </Column>
              </Stack>
              <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                ...
                <Column className="absolute h-[max-content] inset-y-[0] items-start justify-start my-[auto] right-[10%] w-[67%]">
                  ...
                  <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] lg:mx-[15px] xl:mx-[17px] 2xl:mx-[19px] 3xl:mx-[23px] mx-[26px] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[auto]">{`Japan Ramen`}</Text>
                  <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] lg:mx-[32px] xl:mx-[37px] 2xl:mx-[42px] 3xl:mx-[50px] mx-[56px] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400 w-[auto]">
                    <span className="text-amber_600 font-poppins">
                      <>{`$`}</>
                    </span>
              ...
              <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                ...
                <Column className="absolute h-[max-content] inset-y-[0] items-start justify-start my-[auto] right-[10%] w-[67%]">
                  ...
                  <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] lg:mx-[27px] xl:mx-[31px] 2xl:mx-[35px] 3xl:mx-[42px] mx-[47px] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 w-[auto]">{`Fried Rice`}</Text>
                  <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] lg:mx-[32px] xl:mx-[37px] 2xl:mx-[42px] 3xl:mx-[50px] mx-[56px] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400 w-[auto]">
                    <span className="text-amber_600 font-poppins">
                      <>{`$`}</>
                    </span>
          ...
          <Column className="bg-white_A700 items-start w-[24%]">
            ...
            <Text className="font-bold lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] lg:mx-[23px] xl:mx-[26px] 2xl:mx-[30px] 3xl:mx-[36px] mx-[40px] text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`Your Balance`}</Text>
            <Column className="items-center lg:mb-[175px] xl:mb-[200px] 2xl:mb-[225px] 3xl:mb-[270px] mb-[300px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[100%]">
              <Stack className="xl:h-[111px] 2xl:h-[124px] 3xl:h-[149px] h-[165px] lg:h-[97px] mx-[auto] w-[82%]">
                ...
                <Row className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[83%]">
                  <Column className="bg-white_A700 items-start justify-center xl:py-[10px] 2xl:py-[12px] 3xl:py-[14px] py-[16px] lg:py-[9px] rounded-radius16 w-[51%]">
                    <Text className="font-normal xl:mx-[10px] 2xl:mx-[12px] 3xl:mx-[14px] mx-[16px] lg:mx-[9px] not-italic text-bluegray_900 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left w-[auto]">{`Balance`}</Text>
                    <Text className="font-bold xl:mx-[10px] 2xl:mx-[12px] 3xl:mx-[14px] mx-[16px] lg:mx-[9px] text-bluegray_900 lg:text-fs18 xl:text-fs21 2xl:text-fs24 3xl:text-fs28 text-fs32 text-left w-[auto]">{`$12.000`}</Text>
                  </Column>
                  <Column className="lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] mb-[8px] lg:ml-[13px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] ml-[23px] w-[41%]">
                    ...
                    <Row className="items-center justify-between xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
                      <Text className="font-normal xl:ml-[2px] lg:ml-[2px] 3xl:ml-[3px] 2xl:ml-[3px] ml-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left text-white_A700 w-[auto]">{`Top Up`}</Text>
                      <Text className="font-normal not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left text-white_A700 w-[auto]">{`Transfer`}</Text>
                    </Row>
                  </Column>
                </Row>
              </Stack>
              <Column className="items-start justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                <Text className="font-normal lg:mx-[23px] xl:mx-[26px] 2xl:mx-[30px] 3xl:mx-[36px] mx-[40px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Your Address`}</Text>
                <Column className="items-center lg:mt-[1px] 3xl:mt-[2px] 2xl:mt-[2px] xl:mt-[2px] mt-[3px] w-[100%]">
                  <Row className="items-start justify-start mx-[auto] w-[82%]">
                    <Image
                      ...
                      alt="Location"
                    />
                    <Text className="font-bold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] mt-[5px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Elm Street, 23`}</Text>
              ...
              <Column className="items-start justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] mx-[auto] w-[82%]">
                <Text className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`Order Menu`}</Text>
                <Column className="lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[100%]">
                  ...
                  >
                    <Row className="items-center justify-start xl:my-[2px] lg:my-[2px] 3xl:my-[3px] 2xl:my-[3px] my-[4px] w-[100%]">
                      ...
                      <Text className="font-semibold xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:ml-[41px] xl:ml-[47px] 2xl:ml-[53px] 3xl:ml-[63px] ml-[71px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:my-[15px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">
                        <span className="text-bluegray_900 font-poppins">
                          <>{`+`}</>
                        </span>
                        <span className="text-amber_600 font-poppins">
                    ...
                    <Row className="items-center justify-start xl:my-[2px] lg:my-[2px] 3xl:my-[3px] 2xl:my-[3px] my-[4px] w-[100%]">
                      ...
                      <Text className="font-semibold xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] lg:ml-[46px] xl:ml-[53px] 2xl:ml-[60px] 3xl:ml-[72px] ml-[80px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:my-[15px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">
                        <span className="text-bluegray_900 font-poppins">
                          <>{`+`}</>
                        </span>
                        <span className="text-amber_600 font-poppins">
                    ...
                    <Row className="items-center justify-start xl:my-[2px] lg:my-[2px] 3xl:my-[3px] 2xl:my-[3px] my-[4px] w-[100%]">
                      ...
                      <Text className="font-semibold xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] ml-[104px] lg:ml-[60px] xl:ml-[69px] 2xl:ml-[78px] 3xl:ml-[93px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:my-[15px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">
                        <span className="text-bluegray_900 font-poppins">
                          <>{`+`}</>
                        </span>
                        <span className="text-amber_600 font-poppins">
              ...
              <Row className="items-center justify-between lg:mt-[18px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] mt-[31px] mx-[auto] w-[82%]">
                <Text className="font-medium lg:my-[1px] 3xl:my-[2px] 2xl:my-[2px] xl:my-[2px] my-[3px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Service`}</Text>
                <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">
                  <span className="text-bluegray_900 font-poppins">
                    <>{`+`}</>
                  </span>
                  <span className="text-amber_600 font-poppins">
              ...
              <Row className="items-center justify-between lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] mx-[auto] w-[82%]">
                ...
                <Text className="font-medium lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-red_400 w-[auto]">
                  <span className="text-amber_600 font-poppins">
                    <>{`$`}</>
                  </span>
                  <span className="text-bluegray_900 font-poppins">
