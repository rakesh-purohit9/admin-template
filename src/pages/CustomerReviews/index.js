...
const CustomerReviewsPage = () => {
  ...
  const handleNavigate14 = () => navigate("/dashboardrestaurant");
  const handleNavigate4 = () => navigate("/menu");
  const handleNavigate5 = () => navigate("/ordersrestaurant");
  const handleNavigate6 = () => navigate("/settingsrestaurant");
        ...
        <Row className="items-center justify-between w-[100%]">
          ...
          <Column className="lg:mb-[23px] xl:mb-[26px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:mr-[22px] xl:mr-[26px] 2xl:mr-[29px] 3xl:mr-[35px] mr-[39px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[78%]">
            <Row className="items-start justify-between w-[100%]">
              <Text className="font-bold lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left">{`Customer Reviews`}</Text>
              <Image
                src="img_menu_11.svg"
              ...
              <Column className="bg-white_A700 lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[100%]">
                <Row className="items-center justify-between w-[100%]">
                  <Column className="items-start lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] ml-[32px] w-[27%]">
                    <Text className="font-bold lg:mr-[1px] 3xl:mr-[2px] 2xl:mr-[2px] xl:mr-[2px] mr-[3px] text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left">{`Positive Review`}</Text>
                    <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left">{`June 1, 2020, 08:22 AM`}</Text>
                    <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[19px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] mt-[34px] not-italic text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`This Month`}</Text>
                    <Column className="w-[100%]">
                      <Row className="items-start justify-start w-[100%]">
                        <Text className="font-bold text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left">{`3.678`}</Text>
                        <Text className="font-normal lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] mb-[8px] lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[22px] mt-[25px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Reviews`}</Text>
                      </Row>
                    </Column>
                  </Column>
                ...
                <Row className="items-end justify-start mt-[10px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] w-[100%]">
                  <Image
                    ...
                    alt="arrow"
                  />
                  <Text className="font-semibold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-light_green_500">{`+ 15%`}</Text>
                  <Row className="items-center justify-center xl:ml-[105px] 2xl:ml-[119px] 3xl:ml-[142px] ml-[158.58px] lg:ml-[92px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] w-[31%]">
                    <Text className="font-semibold 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Mon`}</Text>
                    <Text className="font-semibold lg:ml-[21px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[33px] ml-[37.22px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Tue`}</Text>
                    <Text className="font-semibold lg:ml-[21px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[32px] ml-[36.47px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Wed`}</Text>
                    <Text className="font-semibold lg:ml-[20px] xl:ml-[23px] 2xl:ml-[26px] 3xl:ml-[31px] ml-[35.22px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Thu`}</Text>
                  </Row>
                  <Text className="font-semibold lg:ml-[25px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] ml-[42.87px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Fri`}</Text>
                  <Text className="font-semibold lg:ml-[27px] xl:ml-[30px] 2xl:ml-[34px] 3xl:ml-[41px] ml-[46.29px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Sat`}</Text>
                  <Text className="font-semibold lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40.12px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Sun`}</Text>
                </Row>
              </Column>
              <Column className="bg-white_A700 lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[100%]">
                <Row className="items-end justify-evenly w-[100%]">
                  <Column className="items-start justify-start w-[28%]">
                    <Text className="font-bold text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left">{`Negative Review`}</Text>
                    <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left">{`June 1, 2020, 08:22 AM`}</Text>
                    <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[19px] xl:mt-[22px] 2xl:mt-[25px] 3xl:mt-[30px] mt-[34px] not-italic text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`This Month`}</Text>
                    <Column className="w-[100%]">
                      <Row className="items-start justify-start w-[100%]">
                        <Text className="font-bold text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left">{`1.678`}</Text>
                        <Text className="font-normal lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] mb-[8px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[22px] mt-[25px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Reviews`}</Text>
                      </Row>
                    </Column>
                  </Column>
                  <Stack className="xl:h-[109px] 2xl:h-[122px] 3xl:h-[146px] h-[162px] lg:h-[95px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[59%]">
                    <Column className="absolute bg-bluegray_900 inset-x-[0] items-center justify-center mx-[auto] xl:py-[3px] lg:py-[3px] 3xl:py-[4px] 2xl:py-[4px] py-[5.5px] rounded-radius8 top-[0] w-[22%]">
                      <Text className="font-semibold mx-[auto] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_100 text-left">{`186`}</Text>
                      <Text className="font-normal mx-[auto] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left text-white_A700">{`Reviews`}</Text>
                    </Column>
                    <Image
                      src="img_polygon3_1.png"
                ...
                <Row className="items-end justify-start mt-[10px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[9px] w-[100%]">
                  <Image
                    ...
                    alt="arrow"
                  />
                  <Text className="font-semibold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-red_400">{`+ 15%`}</Text>
                  <Row className="items-center justify-center xl:ml-[105px] 2xl:ml-[119px] 3xl:ml-[142px] ml-[158.58px] lg:ml-[92px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] w-[31%]">
                    <Text className="font-semibold 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Mon`}</Text>
                    <Text className="font-semibold lg:ml-[21px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[33px] ml-[37.22px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Tue`}</Text>
                    <Text className="font-semibold lg:ml-[21px] xl:ml-[24px] 2xl:ml-[27px] 3xl:ml-[32px] ml-[36.47px] 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`Wed`}</Text>
            ...
            <Column className="items-start justify-start lg:mt-[23px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] mt-[40px] w-[100%]">
              <Text className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left">{`Recent Reviews`}</Text>
              <Column className="items-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                <Row className="items-center justify-between w-[100%]">
                  <div className=" input-wrap">
                    <Image
                      src="img_xmlid_223_7.svg"
                ...
                <Grid className="lg:gap-[10px] xl:gap-[12px] 2xl:gap-[13px] 3xl:gap-[16px] gap-[18px] grid grid-cols-4 lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                    ...
                    <Column className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[83%]">
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          ...
                          <Column className="mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[37%]">
                            <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Ruby Roben`}</Text>
                            <Text className="font-normal xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                      ...
                      <Row className="items-center justify-start ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] mt-[23px] w-[62%]">
                        ...
                        <Column className="items-start xl:mb-[3px] 3xl:mb-[4px] mb-[5px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] w-[61%]">
                          <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Fish Burger`}</Text>
                      ...
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] not-italic text-bluegray_900 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left">{`Ordered June 21, 2020`}</Text>
                    </Column>
                  </Stack>
                  <Stack className="lg:h-[192px] xl:h-[219px] 2xl:h-[247px] 3xl:h-[296px] h-[328px] w-[100%]">
                    <Image
                      src="img_border_36.svg"
                      className="absolute lg:h-[192px] xl:h-[219px] 2xl:h-[247px] 3xl:h-[296px] h-[328px] inset-[0] object-cover rounded-radius16 w-[100%]"
                      alt="border"
                    />
                    <Column className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[83%]">
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          ...
                          <Column className="items-start mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[42%]">
                            <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Samantha W.`}</Text>
                            <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                        <Line className="bg-gray_300 h-[1px] ml-[1px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[99%]" />
                      </Column>
                      <Row className="items-center justify-start ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] mt-[23px] w-[62%]">
                        <Image
                          src="img_image_35.svg"
                          className="lg:h-[33px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] h-[56px] object-contain lg:w-[32px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px] w-[56px]"
                          alt="image"
                        />
                        <Column className="items-start xl:mb-[3px] 3xl:mb-[4px] mb-[5px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] w-[61%]">
                          <Text className="font-medium xl:mr-[4px] lg:mr-[4px] 2xl:mr-[5px] 3xl:mr-[6px] mr-[7px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Beef Burger`}</Text>
                          <Column className="xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[100%]">
                            <RatingBar
                              className="mx-[auto]"
                              selectedStarCount={5}
                      ...
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          ...
                          <Column className="items-start mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[37%]">
                            <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Jack Jock`}</Text>
                            <Text className="font-normal xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                        <Line className="bg-gray_300 h-[1px] ml-[1px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[99%]" />
                      ...
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          ...
                          <Column className="items-start mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[50%]">
                            <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`David Bengkong`}</Text>
                            <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                        <Line className="bg-gray_300 h-[1px] ml-[1px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[99%]" />
                    ...
                    <Column className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[83%]">
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          <div className="bg-gray_400 lg:h-[33px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] h-[56px] ml-[1px] rounded-radius16 lg:w-[32px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px] w-[56px]"></div>
                          <Column className="items-start mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[42%]">
                            <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Cynthia Hope`}</Text>
                            <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                        <Line className="bg-gray_300 h-[1px] ml-[1px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[99%]" />
                  ...
                  <Stack className="lg:h-[192px] xl:h-[219px] 2xl:h-[247px] 3xl:h-[296px] h-[328px] w-[100%]">
                    ...
                    <Column className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[83%]">
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          ...
                          <Column className="items-start mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[38%]">
                            <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Dani Ahmad`}</Text>
                            <Text className="font-normal lg:mr-[2px] 2xl:mr-[3px] xl:mr-[3px] 3xl:mr-[4px] mr-[5px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                        <Line className="bg-gray_300 h-[1px] ml-[1px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[99%]" />
                      </Column>
                      <Row className="items-center justify-start ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] mt-[23px] w-[62%]">
                        <Image
                          src="img_image_39.svg"
                          className="lg:h-[33px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] h-[56px] object-contain lg:w-[32px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px] w-[56px]"
                          alt="image"
                        />
                        <Column className="items-start xl:mb-[3px] 3xl:mb-[4px] mb-[5px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] w-[61%]">
                          <Text className="font-medium lg:mr-[1px] 3xl:mr-[2px] 2xl:mr-[2px] xl:mr-[2px] mr-[3px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Vegan Pizza`}</Text>
                          <Column className="xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[100%]">
                            <RatingBar
                              className="mx-[auto]"
                              selectedStarCount={5}
                    ...
                    <Column className="absolute h-[max-content] inset-[0] items-start justify-center m-[auto] w-[83%]">
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          <div className="bg-gray_400 lg:h-[33px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] h-[56px] ml-[1px] rounded-radius16 lg:w-[32px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px] w-[56px]"></div>
                          <Column className="items-start mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[37%]">
                            <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Jordan Nico`}</Text>
                            <Text className="font-normal mr-[1px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                        <Line className="bg-gray_300 h-[1px] ml-[1px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[99%]" />
                      </Column>
                      <Row className="items-center justify-start ml-[1px] mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] mt-[23px] w-[62%]">
                        <Image
                          src="img_image_40.svg"
                          className="lg:h-[33px] xl:h-[38px] 2xl:h-[43px] 3xl:h-[51px] h-[56px] object-contain lg:w-[32px] xl:w-[37px] 2xl:w-[42px] 3xl:w-[50px] w-[56px]"
                          alt="image"
                        />
                        <Column className="items-start xl:mb-[3px] 3xl:mb-[4px] mb-[5px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] w-[61%]">
                          <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Fried Rice`}</Text>
                          <Column className="xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[100%]">
                            <RatingBar
                              className="mx-[auto]"
                              selectedStarCount={5}
                      ...
                      <Column className="items-center w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          ...
                          <Column className="items-start mb-[1px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] w-[49%]">
                            <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Salsabile Tango`}</Text>
                            <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`User since 2020`}</Text>
                          </Column>
                        </Row>
                        <Line className="bg-gray_300 h-[1px] ml-[1px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[99%]" />
