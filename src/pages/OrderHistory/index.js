...
const OrderHistoryPage = () => {
  ...
  const handleNavigate61 = () => navigate("/");
  const handleNavigate62 = () => navigate("/foodorder");
  const handleNavigate51 = () => navigate("/favoritemenu");
  const handleNavigate52 = () => navigate("/chat");
  const handleNavigate53 = () => navigate("/bills");
  const handleNavigate54 = () => navigate("/settingscustomer");
        ...
        <Row className="items-center justify-start w-[100%]">
          ...
          <Column className="lg:mb-[23px] xl:mb-[26px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[78%]">
            <Row className="items-start justify-between w-[100%]">
              <Text className="font-bold lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left">{`Order History`}</Text>
              <Image
                src="img_menu_4.svg"
              ...
              <Column className="items-center justify-start w-[100%]">
                <Stack className="h-[101px] lg:h-[59px] xl:h-[68px] 2xl:h-[76px] 3xl:h-[91px] w-[100%]">
                  ...
                  <Row className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[50%]">
                    <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Date`}</Text>
                    <Text className="font-semibold xl:ml-[104px] 2xl:ml-[117px] 3xl:ml-[140px] ml-[156px] lg:ml-[91px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Address`}</Text>
                    ...
                    <Text className="font-semibold lg:ml-[51px] xl:ml-[59px] 2xl:ml-[66px] 3xl:ml-[80px] ml-[89px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Status`}</Text>
                  </Row>
                </Stack>
                ...
                <Row className="bg-white_A700 items-center justify-start rounded-radius1 w-[100%]">
                  ...
                  <Row className="items-center justify-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] lg:my-[15px] xl:my-[17px] 2xl:my-[19px] 3xl:my-[23px] my-[26px] w-[45%]">
                    <Column className="items-start lg:my-[1px] 3xl:my-[2px] 2xl:my-[2px] xl:my-[2px] my-[3px] w-[24%]">
                      <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Fish Burger`}</Text>
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`1x`}</Text>
                    </Column>
                    <Text className="font-normal xl:mb-[11px] 3xl:mb-[15px] mb-[17px] lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] xl:mt-[10px] 3xl:mt-[14px] mt-[16px] 2xl:my-[12px] lg:my-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`June 1, 2020, 08:22 AM`}</Text>
                    <Column className="items-start lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] w-[40%]">
                      <Column className="w-[100%]">
                        <Row className="items-center justify-start w-[100%]">
                          <Image
                            src="img_location_2.svg"
                            ...
                            alt="Location"
                          />
                          <Text className="font-semibold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Elm Street, 23 Yogyakarta`}</Text>
                        </Row>
                      </Column>
                      <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[3px] 2xl:mt-[4px] xl:mt-[4px] 3xl:mt-[5px] mt-[6px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`2,97 Km`}</Text>
                    </Column>
                  </Row>
                  <Text className="font-semibold lg:mb-[23px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:ml-[46px] xl:ml-[53px] 2xl:ml-[60px] 3xl:ml-[72px] ml-[80px] lg:mt-[22px] 2xl:mt-[29px] 3xl:mt-[35px] mt-[39px] xl:my-[26px] text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">
                    <span className="text-amber_600 font-poppins">
                      <>{`$`}</>
                    </span>
                    <span className="text-amber_600 font-poppins">
                ...
                <Stack className="lg:h-[310px] xl:h-[354px] 2xl:h-[398px] 3xl:h-[478px] h-[530px] w-[100%]">
                  <Stack className="absolute bottom-[1%] lg:h-[308px] xl:h-[352px] 2xl:h-[396px] 3xl:h-[475px] h-[527px] inset-x-[0] top-[0] w-[100%]">
                    <Stack className="absolute lg:h-[308px] xl:h-[352px] 2xl:h-[396px] 3xl:h-[475px] h-[527px] inset-[0] w-[100%]">
                      <Stack className="absolute lg:h-[308px] xl:h-[352px] 2xl:h-[396px] 3xl:h-[475px] h-[527px] inset-[0] w-[100%]">
                        ...
                        <Row className="absolute bg-white_A700 items-center justify-start rounded-radius1 top-[20%] w-[100%]">
                          ...
                          ></CheckBox>
                          <Image
                            src="img_image_16.svg"
                            className="lg:h-[42px] xl:h-[49px] 2xl:h-[55px] 3xl:h-[65px] h-[72px] lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] xl:my-[11px] 2xl:my-[12px] 3xl:my-[15px] my-[17px] lg:my-[9px] object-contain lg:w-[42px] xl:w-[48px] 2xl:w-[54px] 3xl:w-[64px] w-[72px]"
                            alt="image"
                          />
                          <Row className="items-center justify-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] lg:my-[15px] xl:my-[17px] 2xl:my-[19px] 3xl:my-[23px] my-[26px] w-[45%]">
                            <Column className="items-start lg:my-[1px] 3xl:my-[2px] 2xl:my-[2px] xl:my-[2px] my-[3px] w-[24%]">
                              <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Double Burger`}</Text>
                              <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`1x`}</Text>
                            </Column>
                            <Text className="font-normal xl:mb-[11px] 3xl:mb-[15px] mb-[17px] lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] xl:mt-[10px] 3xl:mt-[14px] mt-[16px] 2xl:my-[12px] lg:my-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`June 1, 2020, 08:22 AM`}</Text>
                            <Column className="items-start lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] w-[40%]">
                      ...
                      <Row className="absolute bg-white_A700 inset-x-[0] inset-y-[40%] items-center justify-start rounded-radius1 w-[100%]">
                        ...
                        ></CheckBox>
                        <Image
                          src="img_image_17.svg"
                          className="lg:h-[42px] xl:h-[49px] 2xl:h-[55px] 3xl:h-[65px] h-[72px] lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] xl:my-[11px] 2xl:my-[12px] 3xl:my-[15px] my-[17px] lg:my-[9px] object-contain lg:w-[42px] xl:w-[48px] 2xl:w-[54px] 3xl:w-[64px] w-[72px]"
                          alt="image"
                        />
                        <Row className="items-center justify-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] lg:my-[15px] xl:my-[17px] 2xl:my-[19px] 3xl:my-[23px] my-[26px] w-[45%]">
                          <Column className="items-start lg:my-[1px] 3xl:my-[2px] 2xl:my-[2px] xl:my-[2px] my-[3px] w-[24%]">
                            <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Beef Burger`}</Text>
                            <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`1x`}</Text>
                          </Column>
                          <Text className="font-normal xl:mb-[11px] 3xl:mb-[15px] mb-[17px] lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] xl:mt-[10px] 3xl:mt-[14px] mt-[16px] 2xl:my-[12px] lg:my-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`June 1, 2020, 08:22 AM`}</Text>
                          <Column className="items-start lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] w-[40%]">
                    ...
                    <Row className="absolute bg-white_A700 bottom-[20%] items-center justify-start rounded-radius1 w-[100%]">
                      ...
                      ></CheckBox>
                      <Image
                        src="img_image_18.svg"
                        className="lg:h-[42px] xl:h-[49px] 2xl:h-[55px] 3xl:h-[65px] h-[72px] lg:ml-[17px] xl:ml-[20px] 2xl:ml-[22px] 3xl:ml-[27px] ml-[30px] xl:my-[11px] 2xl:my-[12px] 3xl:my-[15px] my-[17px] lg:my-[9px] object-contain lg:w-[42px] xl:w-[48px] 2xl:w-[54px] 3xl:w-[64px] w-[72px]"
                        alt="image"
                      />
                      <Row className="items-center justify-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] lg:my-[15px] xl:my-[17px] 2xl:my-[19px] 3xl:my-[23px] my-[26px] w-[45%]">
                        <Column className="items-start lg:my-[1px] 3xl:my-[2px] 2xl:my-[2px] xl:my-[2px] my-[3px] w-[24%]">
                          <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Japanese Ramen`}</Text>
                          <Text className="font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`1x`}</Text>
                        </Column>
                        <Text className="font-normal xl:mb-[11px] 3xl:mb-[15px] mb-[17px] lg:ml-[22px] xl:ml-[26px] 2xl:ml-[29px] 3xl:ml-[35px] ml-[39px] xl:mt-[10px] 3xl:mt-[14px] mt-[16px] 2xl:my-[12px] lg:my-[9px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`June 1, 2020, 08:22 AM`}</Text>
                        <Column className="items-start lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] w-[40%]">
                          <Column className="w-[100%]">
                            <Row className="items-center justify-start w-[100%]">
                              <Image
                                src="img_location_6.svg"
                                className="lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] h-[24px] my-[1px] object-contain lg:w-[14px] xl:w-[16px] 2xl:w-[18px] 3xl:w-[21px] w-[24px]"
                                alt="Location"
                              />
                              <Text className="font-semibold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Elm Street, 23 Yogyakarta`}</Text>
