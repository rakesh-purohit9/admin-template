...
const MenuPage = () => {
  ...
  const handleNavigate24 = () => navigate("/dashboardrestaurant");
  const handleNavigate15 = () => navigate("/ordersrestaurant");
  const handleNavigate16 = () => navigate("/customerreviews");
  const handleNavigate17 = () => navigate("/settingsrestaurant");
  const handleNavigate18 = () => navigate("/");
        ...
        <Row className="items-center justify-between w-[100%]">
          ...
          <Column className="items-center lg:mb-[23px] xl:mb-[26px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:mr-[22px] xl:mr-[26px] 2xl:mr-[29px] 3xl:mr-[35px] mr-[39px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[78%]">
            <Row className="items-start justify-between w-[100%]">
              <Text className="font-bold lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left">{`Menu`}</Text>
              <Image
                src="img_menu_9.svg"
            ...
            <Row className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
              ...
              <Text className="font-normal xl:mb-[3px] 3xl:mb-[4px] mb-[5px] 3xl:ml-[1149px] ml-[1277px] lg:ml-[744px] xl:ml-[851px] 2xl:ml-[958px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] not-italic text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`View all`}</Text>
              <Image
            ...
            <Row className="items-center justify-between lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[100%]">
              ...
              <Column className="bg-white_A700 items-center lg:py-[17px] xl:py-[20px] 2xl:py-[22px] 3xl:py-[27px] py-[30.5px] rounded-radius16 w-[12%]">
                <Image
                  ...
                  alt="Dessert"
                />
                <Text className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500">{`Dessert`}</Text>
              </Column>
              <Column className="bg-white_A700 items-center lg:py-[17px] xl:py-[20px] 2xl:py-[22px] 3xl:py-[27px] py-[30.5px] rounded-radius16 w-[12%]">
                <Image
                  src="img_chinese.svg"
                  ...
                  alt="Chinese"
                />
                <Text className="font-normal xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] not-italic text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500">{`Noodle`}</Text>
              </Column>
            </Row>
            <Column className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
              <Row className="items-center justify-start w-[100%]">
                <Text className="font-bold text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left">{`Popular This Week`}</Text>
                <Text className="font-normal xl:mb-[3px] 3xl:mb-[4px] mb-[5px] 3xl:ml-[1050px] ml-[1166px] lg:ml-[680px] xl:ml-[777px] 2xl:ml-[875px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] not-italic text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`View all`}</Text>
                <Image
                    ...
                    <Column className="w-[100%]">
                      <Row className="items-start justify-between w-[100%]">
                        ...
                        <Column className="items-start justify-start lg:mb-[5px] 2xl:mb-[6px] xl:mb-[6px] 3xl:mb-[8px] mb-[9px] w-[64%]">
                          ...
                          <Text className="font-bold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-red_400">
                            <span className="text-amber_600 font-poppins">
                              <>{`$`}</>
                            </span>
                            <span className="text-bluegray_900 font-poppins">
                          ...
                          <Row className="items-center justify-start mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] w-[89%]">
                            ...
                            <Text className="font-normal lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`1k+ User Reviews`}</Text>
                          </Row>
                        </Column>
                      </Row>
                    </Column>
            ...
            <Column className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
              <Row className="items-center justify-start w-[100%]">
                <Text className="font-bold text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left">{`Best Seller`}</Text>
                <Text className="font-normal xl:mb-[3px] 3xl:mb-[4px] mb-[5px] 3xl:ml-[1140px] ml-[1266px] lg:ml-[738px] xl:ml-[844px] 2xl:ml-[950px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] not-italic text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`View all`}</Text>
                <Image
              ...
              >
                <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                  ...
                  <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[79%]">
                    ...
                    <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] mx-[auto] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18">{`Pepperoni Pizza`}</Text>
                    <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
                      <span className="text-bluegray_900 font-poppins">
                    ...
                    <Row className="items-center justify-between xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[87%]">
                      <Text className="font-normal not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left">{`Sold 1k`}</Text>
                      <Line className="bg-gray_300 lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] h-[24px] my-[1px] rotate-[90deg] w-[1px]" />
                      <Text className="font-semibold lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-light_green_500">{`+ 15%`}</Text>
                      <Image
                        src="img_arrow_3.svg"
                ...
                <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                  ...
                  <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[79%]">
                    ...
                    <Text className="font-medium ml-[10px] 2xl:ml-[7px] 3xl:ml-[9px] 2xl:mr-[6px] 3xl:mr-[8px] mr-[9px] lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] lg:mx-[5px] xl:mx-[6px] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18">{`Japanese Ramen`}</Text>
                    <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
                ...
                <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                  ...
                  <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[79%]">
                    ...
                    <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] mx-[auto] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18">{`Fried Rice`}</Text>
                    <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
                ...
                <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                  ...
                  <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[79%]">
                    ...
                    <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] mx-[auto] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18">{`Vegan Pizza`}</Text>
                    <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
                ...
                <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                  ...
                  <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[79%]">
                    ...
                    <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] mx-[auto] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18">{`Beef Burger`}</Text>
                    <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
                ...
                <Stack className="lg:h-[219px] xl:h-[250px] 2xl:h-[281px] 3xl:h-[337px] h-[374px] w-[100%]">
                  ...
                  <Column className="absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[79%]">
                    ...
                    <Text className="font-medium lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] mx-[auto] text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18">{`Fish Burger`}</Text>
                    <Text className="font-bold lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] text-center lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-red_400">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
            ...
            <Column className="items-center justify-start lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
              <Row className="items-center justify-start w-[100%]">
                <Text className="font-bold text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left">{`Promo`}</Text>
                <Text className="font-normal xl:mb-[3px] 3xl:mb-[4px] mb-[5px] 3xl:ml-[1181px] ml-[1312px] lg:ml-[765px] xl:ml-[875px] 2xl:ml-[984px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] not-italic text-amber_600 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`View all`}</Text>
                <Image
              ...
              >
                    ...
                    <Column className="lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] w-[47%]">
                      <Column className="items-start justify-start w-[100%]">
                        ...
                        <Column className="xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            <Text className="font-bold lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-red_400">
                              <span className="text-amber_600 font-poppins">
                                <>{`$`}</>
                              </span>
                              <span className="text-bluegray_900 font-poppins">
                            ...
                            <Text className="font-medium line-through xl:mb-[3px] 3xl:mb-[4px] mb-[5px] lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] ml-[8px] xl:mt-[2px] 3xl:mt-[3px] mt-[4px] lg:my-[2px] 2xl:my-[3px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left">{`$5.59`}</Text>
                          </Row>
                        </Column>
                      </Column>
                      <Row className="items-center justify-between lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] w-[100%]">
                        ...
                        <Text className="font-normal not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left">{`1k+ Reviews`}</Text>
                      </Row>
                    </Column>
                    <Image
                      src="img_image_30.svg"
                ...
                <Stack className="lg:h-[112px] xl:h-[129px] 2xl:h-[145px] 3xl:h-[173px] h-[192px] w-[100%]">
                  ...
                  <Row className="absolute h-[max-content] inset-[0] items-end justify-center m-[auto] w-[87%]">
                    <Column className="lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] w-[47%]">
                      <Column className="items-start justify-start w-[100%]">
                        <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Double Burger`}</Text>
                        <Column className="xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            <Text className="font-bold lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-red_400">
                              <span className="text-amber_600 font-poppins">
                ...
                <Stack className="lg:h-[112px] xl:h-[129px] 2xl:h-[145px] 3xl:h-[173px] h-[192px] w-[100%]">
                  ...
                  <Row className="absolute h-[max-content] inset-[0] items-end justify-center m-[auto] w-[87%]">
                    <Column className="lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] w-[47%]">
                      <Column className="items-start justify-start w-[100%]">
                        <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Beef Burger`}</Text>
                        <Column className="xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            <Text className="font-bold lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-red_400">
                              <span className="text-amber_600 font-poppins">
                ...
                <Stack className="lg:h-[112px] xl:h-[129px] 2xl:h-[145px] 3xl:h-[173px] h-[192px] w-[100%]">
                  ...
                  <Row className="absolute h-[max-content] inset-[0] items-end justify-center m-[auto] w-[87%]">
                    <Column className="lg:mt-[28px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] mt-[48px] w-[47%]">
                      <Column className="items-start justify-start w-[100%]">
                        <Text className="font-medium mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left">{`Cheese Burger`}</Text>
                        <Column className="xl:mt-[2px] lg:mt-[2px] 3xl:mt-[3px] 2xl:mt-[3px] mt-[4px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            <Text className="font-bold lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left text-red_400">
                              <span className="text-amber_600 font-poppins">
