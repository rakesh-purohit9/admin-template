        ...
        <Row className="items-center justify-start w-[100%]">
            ...
            <Column className="">
              <Column className="items-center justify-start lg:mb-[11px] xl:mb-[13px] 2xl:mb-[15px] 3xl:mb-[18px] mb-[20px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] mx-[auto] w-[73%]">
                ...
                <Row className="bg-amber_600 items-center justify-start xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] rounded-radius20 w-[100%]">
                  <Image
                    src={"images/img_orderdiscussio_3.svg"}
                    className="lg:h-[24px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] h-[40px] lg:ml-[14px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] ml-[24px] xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] object-contain lg:w-[23px] xl:w-[26px] 2xl:w-[30px] 3xl:w-[36px] w-[40px]"
                    alt="OrderDiscussio"
                  />
          ...
          <Column className="lg:mb-[37px] xl:mb-[42px] 2xl:mb-[48px] 3xl:mb-[57px] mb-[64px] lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] ml-[40px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[78%]">
            <Row className="items-start justify-between w-[100%]">
              <Text className="font-bold lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left w-[auto]">{`Message`}</Text>
              <Image
                src={"images/img_menu_3.svg"}
            ...
            <Row className="items-center justify-between lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
              <Column className="bg-white_A700 items-start rounded-radius16 w-[34%]">
                ...
                <Text className="font-semibold lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] lg:mx-[18px] xl:mx-[21px] 2xl:mx-[24px] 3xl:mx-[28px] mx-[32px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Your Chat`}</Text>
                      ...
                      >
                        <Column className="lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            ...
                            <Column className="xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] my-[1px] w-[72%]">
                              <Row className="items-start justify-between w-[100%]">
                                <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Driver #1`}</Text>
                                <Text className="font-normal lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`12:45 PM`}</Text>
                              </Row>
                              <Row className="items-start justify-between lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] mt-[5px] w-[100%]">
                                <Text className="font-normal lg:mt-[1px] 3xl:mt-[2px] 2xl:mt-[2px] xl:mt-[2px] mt-[3px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Lorem ipsum dolor sit amet...`}</Text>
                                <Image
                                  src={"images/img_doublecheck.svg"}
                        ...
                        <Column className="lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            ...
                            <Column className="items-start xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] my-[1px] w-[40%]">
                              <Text className="font-semibold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Driver #2`}</Text>
                              <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Lorem ipsum dolor sit amet...`}</Text>
                            </Column>
                            <Column className="items-start ml-[108px] lg:ml-[63px] xl:ml-[72px] 2xl:ml-[81px] 3xl:ml-[97px] my-[1px] w-[11%]">
                              <Column className="w-[100%]">
                                <Text className="font-normal not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`12:45 PM`}</Text>
                              </Column>
                              <Image
                                src={"images/img_notif.svg"}
                        ...
                        <Column className="lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            ...
                            <Column className="xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] my-[1px] w-[72%]">
                              <Row className="items-start justify-between w-[100%]">
                                <Text className="font-semibold text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Driver #3`}</Text>
                                <Text className="font-normal lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`12:45 PM`}</Text>
                              </Row>
                              <Row className="items-start justify-between lg:mt-[2px] 2xl:mt-[3px] xl:mt-[3px] 3xl:mt-[4px] mt-[5px] w-[100%]">
                                <Text className="font-normal lg:mt-[1px] 3xl:mt-[2px] 2xl:mt-[2px] xl:mt-[2px] mt-[3px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Lorem ipsum dolor sit amet...`}</Text>
                                <Image
                                  src={"images/img_doublecheck_1.svg"}
                                  className="lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] h-[24px] object-contain lg:w-[14px] xl:w-[16px] 2xl:w-[18px] 3xl:w-[21px] w-[24px]"
                                  alt="DoubleCheck"
                                />
                              </Row>
                        ...
                        <Column className="lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            ...
                            <Column className="items-start xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] my-[1px] w-[40%]">
                              <Text className="font-semibold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Driver #4`}</Text>
                              <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Lorem ipsum dolor sit amet...`}</Text>
                            </Column>
                            <Column className="items-start ml-[108px] lg:ml-[63px] xl:ml-[72px] 2xl:ml-[81px] 3xl:ml-[97px] my-[1px] w-[11%]">
                              <Column className="w-[100%]">
                        ...
                        <Column className="lg:my-[4px] xl:my-[5px] 2xl:my-[6px] 3xl:my-[7px] my-[8px] w-[100%]">
                          <Row className="items-center justify-start w-[100%]">
                            <div className="bg-gray_400 lg:h-[35px] xl:h-[41px] 2xl:h-[46px] 3xl:h-[55px] h-[60px] lg:ml-[18px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] ml-[32px] rounded-radius16 lg:w-[35px] xl:w-[40px] 2xl:w-[45px] 3xl:w-[54px] w-[60px]"></div>
                            <Column className="items-start xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] my-[1px] w-[40%]">
                              <Text className="font-semibold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Driver #5`}</Text>
                              <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Lorem ipsum dolor sit amet...`}</Text>
                            </Column>
                            <Column className="items-start ml-[108px] lg:ml-[63px] xl:ml-[72px] 2xl:ml-[81px] 3xl:ml-[97px] my-[1px] w-[11%]">
                              <Column className="w-[100%]">
                      ...
                      <Column className="xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
                        <Row className="items-start justify-start w-[100%]">
                          ...
                          <Column className="items-start justify-start xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] ml-[16px] lg:ml-[9px] my-[1px] w-[40%]">
                            <Text className="font-semibold mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Driver #6`}</Text>
                            <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Lorem ipsum dolor sit amet...`}</Text>
                          </Column>
                          <Text className="font-normal lg:mb-[21px] xl:mb-[24px] 2xl:mb-[27px] 3xl:mb-[33px] mb-[37px] ml-[108px] lg:ml-[63px] xl:ml-[72px] 2xl:ml-[81px] 3xl:ml-[97px] mt-[1px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`12:45 PM`}</Text>
                        </Row>
                        <Line className="bg-gray_100 h-[1px] lg:mt-[12px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] w-[100%]" />
                      </Column>
                    </Column>
              ...
              <Column className="bg-white_A700 items-center mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] rounded-radius16 w-[63%]">
                <Row className="items-center justify-start lg:mt-[22px] xl:mt-[26px] 2xl:mt-[29px] 3xl:mt-[35px] mt-[39px] mx-[auto] w-[92%]">
                  ...
                  <Column className="items-start lg:ml-[14px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] ml-[24px] w-[13%]">
                    <Text className="font-bold text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`Driver #2`}</Text>
                    <CheckBox
                ...
                <Column className="items-start justify-start lg:mt-[18px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] mt-[31px] w-[100%]">
                  <Text className="font-semibold 3xl:mx-[115px] mx-[128px] lg:mx-[74px] xl:mx-[85px] 2xl:mx-[96px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Driver`}</Text>
                    ...
                    <Row className="items-start justify-start w-[100%]">
                      ...
                      <Column className="items-start justify-start lg:ml-[16px] xl:ml-[18px] 2xl:ml-[21px] 3xl:ml-[25px] ml-[28px] w-[44%]">
                        <Column className="font-poppins w-[100%]">
                          <FloatingInput
                            className="peer focus:border-blue-600 placeholder-transparent focus:outline-none placeholder:bg-amber_600 bg-amber_600 border-0 border-b-[1px] border-gray_100_3f border-solid font-normal placeholder:left-[24.8900000000001px] not-italic pb-[18.545px] pl-[24.890015px] pr-[21.109985px] pt-[17.545px] rounded-radius16 placeholder:text-bluegray_900 text-bluegray_900 text-center lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 placeholder:top-[0] top-[0] w-[100%]"
                            name="Group195"
                            labelClasses="absolute transition-all -translate-y-[4px] peer-focus:-translate-y-[4px] peer-placeholder-shown:translate-y-[17px] bg-amber_600 left-[24.8900000000001px] top-[0] text-bluegray_900 peer-placeholder-shown:font-normal peer-placeholder-shown:leading-lh1 peer-placeholder-shown:text-fs18 peer-placeholder-shown:font-fontfamily peer-placeholder-shown:text-bluegray_900 peer-focus:font-normal peer-focus:leading-lh1 peer-focus:text-fs18 peer-focus:font-fontfamily peer-focus:text-bluegray_900"
                            wrapperClasses="bg-transparent border-0 top-[0] w-[100%]"
                            labelText="Your order according to application yes?"
                            defaultText="Your order according to application yes?"
                          ></FloatingInput>
                        </Column>
                        <Text className="font-cairo font-normal mr-[10px] lg:mr-[5px] xl:mr-[6px] 2xl:mr-[7px] 3xl:mr-[9px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`12:45 PM`}</Text>
                      </Column>
                    </Row>
                  </Column>
                </Column>
                <Column className="lg:mt-[14px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] mt-[24px] w-[100%]">
                  <Column className="items-end w-[100%]">
                    <Text className="font-semibold 3xl:mx-[108px] mx-[121px] lg:mx-[70px] xl:mx-[80px] 2xl:mx-[90px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`You`}</Text>
                  </Column>
                  <Column className="xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
...
application. Thank you`}
                        ...
                        <Text className="font-cairo font-normal ml-[10px] lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[9px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`12:45 PM`}</Text>
                      </Column>
                      <Image
                        src={"images/img_avatar_1.svg"}
                ...
                <Row className="bg-gray_100 border-2 border-gray_100 border-solid items-center justify-end xl:mb-[21px] 2xl:mb-[24px] 3xl:mb-[28px] mb-[32px] xl:mt-[20px] 2xl:mt-[23px] 3xl:mt-[27px] mt-[31px] mx-[auto] lg:my-[18px] rounded-radius16 w-[93%]">
                  <Text className="font-normal xl:mb-[17px] 2xl:mb-[19px] 3xl:mb-[23px] mb-[26px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] mt-[27px] lg:my-[15px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Write your message...`}</Text>
                  <Image
