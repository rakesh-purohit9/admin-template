...
const FoodOrderPage = () => {
  ...
  const handleNavigate88 = () => navigate("/");
  const handleNavigate89 = () => navigate("/favoritemenu");
  const handleNavigate90 = () => navigate("/chat");
  const handleNavigate91 = () => navigate("/orderhistory");
  const handleNavigate85 = () => navigate("/bills");
  const handleNavigate86 = () => navigate("/settingscustomer");
  const handleNavigate45 = () => navigate("/dashboardrestaurant");
  const handleNavigate11 = () => navigate("/dashboardrestaurant");
        ...
        <Row className="items-center justify-between w-[100%]">
          <aside className="bg-white_A700 items-center w-[18%]">
            <Column className="">
              <Column className="items-center justify-start lg:mb-[264px] xl:mb-[302px] 2xl:mb-[340px] 3xl:mb-[408px] mb-[454px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] mx-[auto] w-[73%]">
                ...
                >
                  <Image
                    src={"images/img_restaurantloca_1.svg"}
                ...
                <Row className="bg-amber_600 items-center justify-start xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] rounded-radius20 w-[100%]">
                  <Image
                    src={"images/img_deliveryscoote_1.svg"}
                    ...
                    alt="DeliveryScoote"
                  />
                  <Text className="font-medium lg:ml-[14px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] ml-[24px] lg:my-[13px] xl:my-[15px] 2xl:my-[16px] 3xl:my-[20px] my-[22.5px] lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-white_A700 w-[auto]">{`Food Order`}</Text>
                </Row>
                <Row
                ...
                >
                  <Image
                    src={"images/img_orderdiscussio_1.svg"}
                    className="lg:h-[24px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] h-[40px] lg:ml-[14px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] ml-[24px] xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] object-contain lg:w-[23px] xl:w-[26px] 2xl:w-[30px] 3xl:w-[36px] w-[40px]"
                    alt="OrderDiscussio"
                  />
                ...
                >
                  <Image
                    src={"images/img_24hourfoodde_1.svg"}
                    className="lg:h-[24px] xl:h-[27px] 2xl:h-[31px] 3xl:h-[37px] h-[40px] lg:ml-[14px] xl:ml-[16px] 2xl:ml-[18px] 3xl:ml-[21px] ml-[24px] xl:my-[10px] 2xl:my-[12px] 3xl:my-[14px] my-[16px] lg:my-[9px] object-contain lg:w-[23px] xl:w-[26px] 2xl:w-[30px] 3xl:w-[36px] w-[40px]"
                    alt="24HourFoodDe"
                  />
          ...
          <Column className="lg:mb-[23px] xl:mb-[26px] 2xl:mb-[30px] 3xl:mb-[36px] mb-[40px] lg:mt-[32px] xl:mt-[37px] 2xl:mt-[42px] 3xl:mt-[50px] mt-[56px] w-[54%]">
            <Row className="items-start justify-between w-[100%]">
              <Text className="font-bold lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] mb-[6px] text-bluegray_900 lg:text-fs21 xl:text-fs24 2xl:text-fs27 3xl:text-fs32 text-fs36 text-left w-[auto]">{`Food Order`}</Text>
              <div className="bg-transparent border-0 w-[49%] input-wrap">
                <Image
                  src={"images/img_xmlid_223_1.svg"}
            ...
            <Grid className="xl:gap-[10px] 2xl:gap-[12px] 3xl:gap-[14px] gap-[16px] lg:gap-[9px] grid grid-cols-3 lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
              <Column className="bg-white_A700 items-start justify-start lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[100%]">
                <Column className="items-center w-[100%]">
                  <Text className="font-bold mx-[auto] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Order #1`}</Text>
                  <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Nov 11, 2021 , 18:38 PM`}</Text>
                  <Line className="bg-gray_300 h-[1px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]" />
                </Column>
                <Text className="font-medium xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] lg:mx-[21px] xl:mx-[24px] 2xl:mx-[27px] 3xl:mx-[32px] mx-[36px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Fast Food Resto`}</Text>
                ...
                <Column className="items-center xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
                  ...
                  <Column className="items-start justify-start xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] mx-[auto] w-[81%]">
                    ...
                    <Column className="xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] w-[100%]">
                      <Row className="items-center justify-start w-[100%]">
                        ...
                        <Text className="font-semibold 2xl:mb-[15px] 3xl:mb-[18px] mb-[21px] lg:ml-[22px] xl:ml-[25px] 2xl:ml-[28px] 3xl:ml-[34px] ml-[38px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] lg:my-[12px] xl:my-[14px] text-bluegray_900 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left w-[auto]">
                          <span className="text-bluegray_900 font-poppins">
                            <>{`+`}</>
                          </span>
                          <span className="text-amber_600 font-poppins">
                      ...
                      <Row className="items-center justify-start lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] w-[100%]">
                        ...
                        <Text className="font-semibold 2xl:mb-[15px] 3xl:mb-[18px] mb-[21px] lg:ml-[26px] xl:ml-[30px] 2xl:ml-[33px] 3xl:ml-[40px] ml-[45px] 2xl:mt-[16px] 3xl:mt-[19px] mt-[22px] lg:my-[12px] xl:my-[14px] text-bluegray_900 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-left w-[auto]">
                          <span className="text-bluegray_900 font-poppins">
                            <>{`+`}</>
                          </span>
                          <span className="text-amber_600 font-poppins">
                  ...
                  <Line className="bg-gray_300 h-[1px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]" />
                  <Row className="items-center justify-between xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] mx-[auto] w-[81%]">
                    <Text className="font-medium text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Total`}</Text>
                    <Text className="font-medium lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left text-red_400 w-[auto]">
                      <span className="text-amber_600 font-poppins">
                        <>{`$`}</>
                      </span>
                      <span className="text-bluegray_900 font-poppins">
              ...
              <Column className="bg-white_A700 border border-amber_600 border-solid items-start justify-start lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[100%]">
                <Column className="items-center w-[100%]">
                  <Text className="font-bold mx-[auto] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Order #2`}</Text>
                  <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Nov 11, 2021 , 18:38 PM`}</Text>
                  <Line className="bg-gray_300 h-[1px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]" />
                </Column>
                <Text className="font-medium xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] lg:mx-[21px] xl:mx-[24px] 2xl:mx-[27px] 3xl:mx-[32px] mx-[36px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Fast Food Resto`}</Text>
              ...
              <Column className="bg-white_A700 items-start justify-start lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[100%]">
                <Column className="items-center w-[100%]">
                  <Text className="font-bold mx-[auto] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Order #3`}</Text>
                  <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Nov 11, 2021 , 18:38 PM`}</Text>
                  <Line className="bg-gray_300 h-[1px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]" />
                </Column>
                <Text className="font-medium xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] lg:mx-[21px] xl:mx-[24px] 2xl:mx-[27px] 3xl:mx-[32px] mx-[36px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Fast Food Resto`}</Text>
              ...
              <Column className="bg-white_A700 items-start justify-start lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[100%]">
                <Column className="items-center w-[100%]">
                  <Text className="font-bold mx-[auto] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Order #4`}</Text>
                  <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Nov 11, 2021 , 18:38 PM`}</Text>
                  <Line className="bg-gray_300 h-[1px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]" />
                </Column>
                <Text className="font-medium xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] lg:mx-[21px] xl:mx-[24px] 2xl:mx-[27px] 3xl:mx-[32px] mx-[36px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Fast Food Resto`}</Text>
              ...
              <Column className="bg-white_A700 items-start justify-start lg:py-[18px] xl:py-[21px] 2xl:py-[24px] 3xl:py-[28px] py-[32px] rounded-radius16 w-[100%]">
                <Column className="items-center w-[100%]">
                  <Text className="font-bold mx-[auto] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Order #5`}</Text>
                  <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Nov 11, 2021 , 18:38 PM`}</Text>
                  <Line className="bg-gray_300 h-[1px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]" />
                </Column>
                <Text className="font-medium xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] lg:mx-[21px] xl:mx-[24px] 2xl:mx-[27px] 3xl:mx-[32px] mx-[36px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Fast Food Resto`}</Text>
              ...
              <Column className="bg-white_A700 items-start justify-start rounded-radius16 w-[100%]">
                <Column className="items-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
                  <Text className="font-bold mx-[auto] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Order #6`}</Text>
                  <Text className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] mt-[8px] mx-[auto] not-italic 2xl:text-fs10 3xl:text-fs12 text-fs14 lg:text-fs8 xl:text-fs9 text-gray_500 text-left w-[auto]">{`Nov 11, 2021 , 18:38 PM`}</Text>
                  <Line className="bg-gray_300 h-[1px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] mt-[16px] lg:mt-[9px] mx-[auto] w-[81%]" />
                </Column>
                <Text className="font-medium xl:mt-[10px] 2xl:mt-[11px] 3xl:mt-[13px] mt-[15px] lg:mt-[8px] lg:mx-[21px] xl:mx-[24px] 2xl:mx-[27px] 3xl:mx-[32px] mx-[36px] text-bluegray_900 lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-left w-[auto]">{`Fast Food Resto`}</Text>
          ...
          <Column className="bg-white_A700 items-start w-[24%]">
            ...
            <Text className="font-bold lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] lg:mx-[23px] xl:mx-[26px] 2xl:mx-[30px] 3xl:mx-[36px] mx-[40px] text-bluegray_900 lg:text-fs14 xl:text-fs16 2xl:text-fs18 3xl:text-fs21 text-fs24 text-left w-[auto]">{`Order Tracker`}</Text>
            <Column className="items-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] w-[100%]">
              <Stack className="lg:h-[219px] xl:h-[251px] 2xl:h-[282px] 3xl:h-[338px] h-[375px] mx-[auto] lg:w-[218px] xl:w-[250px] 2xl:w-[281px] 3xl:w-[337px] w-[375px]">
                ...
                <Stack className="absolute lg:h-[159px] xl:h-[182px] 2xl:h-[204px] 3xl:h-[245px] h-[271.5px] left-[23%] top-[11%] w-[43%]">
                  ...
                  />
                  <Image
                    src={"images/img_destination.svg"}
            ...
            <Text className="font-normal lg:mt-[18px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] mt-[32px] lg:mx-[23px] xl:mx-[26px] 2xl:mx-[30px] 3xl:mx-[36px] mx-[40px] not-italic lg:text-fs10 xl:text-fs12 2xl:text-fs13 3xl:text-fs16 text-fs18 text-gray_500 text-left w-[auto]">{`Your Address`}</Text>
